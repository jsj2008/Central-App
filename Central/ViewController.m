...
- (void)viewDidLoad
{
    ...
    if(![isOpened isEqualToString:@"Opened"]){
        ...
        //replace this code with any code to show one time thing when app opens
        /*UIAlertView *alert = [[UIAlertView alloc] initWithTitle:@"Welcome!"
         message:@"Use the settings tool in the lower left corner to sign in to the app and select a background"
         delegate:nil
